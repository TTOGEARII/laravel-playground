    ...
    */
    'raids' => [
        ...
        'guides' => [
            ...
            // 보스명 제목 검색 접미사 — "{보스명} {접미사}"(예: "비나 공략")로 디씨·아카를 제목 검색해
            // 개념글·추천글에 잘 안 올라오는 레이드 공략을 보강 수집한다.
            'search_suffix' => env('SGI_GUIDE_SEARCH_SUFFIX', '공략'),
            // 잡담 걸러내기 — 제목에 아래 표현이 있으면(또는 '?'로 끝나는 질문글이면) 공략으로 안 본다.
            // 검색 수집은 목록 수집보다 잡담 유입이 많아 필수.
            'exclude_title_keywords' => ['ㅋㅋ', 'ㅎㅎ', 'ㅠㅠ', 'ㅜㅜ', '시발', '씨발', '싯팔', 'ㅅㅂ', '존나', '웃기', '개빵'],
