    ...
    */
    'product_match' => [
        ...
        'strip_patterns' => [
            ...
            '/g\.s\.c\.?/iu',
            // 일러스트레이터 크레딧("Illustrated by 이토 노이지"/"Illustrated by LOVECACAO") — 원화가명은
            // 상품 구분이 아닌 부연이라 제거한다. 단, 크레딧 뒤 스케일/에디션(1/4 · Deluxe 등)까지 삼키면
            // 다른 상품(아미아미 영문 Deluxe/Regular)이 같은 시그니처가 되므로, 이름 토큰(라틴/한글)만 먹되
            // 숫자·에디션/폼팩터 키워드가 나오면 멈춘다.
            '/illustrated\s+by\s+[가-힣a-z.-]+(?:\s+(?!디럭스|deluxe|regular|special|standard|edition|statue|complete|scale|스케일|버전|ver|\d)[가-힣a-z.-]+)*/iu',
