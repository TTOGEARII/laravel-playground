    ...
    */
    'product_match' => [
        ...
        'match_stopwords' => [
            ...
            '공굿', '테마', '봉제인형', '시리즈', '게임', '논스케일',
            // ※ 인형/누이/누이구루미(인형류)는 불용어로 넣지 않는다 — 넣으면 남는 변별 토큰이 캐릭터명뿐인데
            //   1글자 캐릭터명(카가미네 린/렌 등)은 토큰에서 탈락해 서로 다른 캐릭터가 충돌·오병합된다
            //   (dry-run 검수에서 확인). 인형류 표기 차이는 자동 병합 대신 otaku-shop:merge 수동으로 처리.
