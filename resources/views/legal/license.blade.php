...
@section('content')
    <x-legal-document title="라이센스" :updated="$updated">
        ...
        <ul>
            <li><strong>내한공연</strong>: 짱짱이의 짱짱한 일상 — 일본 가수 내한 공연 캘린더(j-pop-playlist.tistory.com, CC BY-NC-ND) · 예매(티켓오픈) 정보: mycon(mycon.me) · 일정 교차 확인: 각 아티스트 공식 X(MusicBrainz 연동)·구글 뉴스</li>
