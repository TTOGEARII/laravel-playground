...
/**
 * 따빼몰 (ttabbaemall.co.kr) 크롤러.
 * 카페24 기반: product/detail.html?product_no=, "상품명 :", "판매가 : N원" 구조.
 */
class TtabbaemallCrawler extends AbstractShopCrawler
{
    private const BASE_URL = 'https://ttabbaemall.co.kr';
    ...
    protected function getListingUrls(): array
    {
        return [
            self::BASE_URL . '/',
            self::BASE_URL . '/product/list.html?cate_no=24', // 신규예약
            self::BASE_URL . '/product/list.html?cate_no=23', // 신규입고
        ];
    }
